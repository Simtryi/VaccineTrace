...
const HDWalletProvider = require('@truffle/hdwallet-provider');
const mnemonic = "seven jump turkey latin morning turkey oak finish okay often behind student";
...
module.exports = {
  ...
  networks: {
    ...
    rainkeby: {
      provider: () => new HDWalletProvider(mnemonic, `https://rinkeby.infura.io/v3/e66366693b27415da41e72d71e60e392`),
